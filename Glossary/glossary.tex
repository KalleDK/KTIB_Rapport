...
\newglossaryentry{rodLED}{
    name=rød LED,
    description={bølgelængde (nm) på ca. 633-635}
}

\newglossaryentry{groenLED}{
    name=grøn LED,
    description={bølgelængde (nm) på ca. 555-565}
}

\newglossaryentry{blaaknap}{
    name=blå knap,
    description={HEX farve \# 337AB7}
}

\newglossaryentry{hvidknap}{
    name=hvid knap,
    description={HEX farve FFFFFF}
}
